...
function invocarMetodo(objeto, metodo) {
  ...
  //por que no se puede objeto.metodo() ??
  objeto[metodo]()
}
...
function tieneEmail(usuario) {
  ...
  //por que no funciona con el triple = ??
...
/*var users = [ usuario1
  {name: 'juan', esPremium: false}
  {name: 'daniel', esPremium: false}
  {name: 'valentina', esPremium: false}
]*/
...
/*var usuario = {
  ...
  /*Por que no funciona con let in?
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Devuelve la suma
  var suma = 0
  for (let i = 0; usuario.posts.length > i; i++ ) {
    suma += usuario.posts[i].likes;
  }
  return suma
}
